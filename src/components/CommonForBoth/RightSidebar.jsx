        ...
        <SimpleBar style={{ height: "900px" }}>
          <div data-simplebar className="h-100">
            ...
            <div className="p-4">
              ...
              <div className="mb-2">
                <Link to="//StarterKit-v-light.react.BUILD.com" target="_blank">
                  <img src={layout1} className="img-fluid img-thumbnail" alt="" />
                </Link>
              </div>

              <div className="mb-2">
                <Link to="//StarterKit-v-dark.react.BUILD.com" target="_blank">
                  <img src={layout2} className="img-fluid img-thumbnail" alt="" />
                </Link>
              </div>

              <div className="mb-2">
                <Link to="//StarterKit-v-rtl.react.BUILD.com" target="_blank">
                  <img src={layout3} className="img-fluid img-thumbnail" alt="" />
                </Link>
              </div>

              <Link
                to="//1.envato.market/StarterKitreact"
